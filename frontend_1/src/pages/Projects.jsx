                                            ...
                                            <div className="space-y-1 md:space-y-3">
                                                <div className="hidden md:flex flex-wrap gap-1.5 text-white">
                                                    {project.tags.slice(0, 2).map(tag => (
                                                        <span key={tag} className="px-2 py-0.5 bg-white/10 backdrop-blur-md rounded-full text-[9px] font-bold uppercase tracking-widest text-white border border-white/20">
                                                            {tag}
                                                        </span>
                                                    ))}
                                                </div>
