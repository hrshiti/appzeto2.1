            ...
            <div className="font-sans antialiased text-slate-900 bg-white overflow-hidden selection:bg-[#0EA5E9] selection:text-white" ref={containerRef}>
                ...
                <section className="relative min-h-0 md:h-screen flex items-center pt-24 md:pt-0 overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        <div className="space-y-4 max-w-lg z-10 text-center lg:text-left mx-auto lg:mx-0">
                            <span className="text-[#0EA5E9] font-bold tracking-widest uppercase text-[10px] md:text-xs border-b-2 border-[#0EA5E9] pb-1 inline-block">Appzeto Care</span>
                            <h1 className="text-3xl md:text-6xl lg:text-7xl font-black leading-[1.1] text-[#082F49] tracking-tight">
                            ...
                            <p className="text-slate-500 text-sm md:text-lg leading-relaxed font-medium">Bridge the gap between patients and providers with our unified digital health platform.</p>
                            <div className="relative max-w-sm pt-4 mx-auto lg:mx-0">
                                <Link to="/contact" className="w-full pl-6 pr-2 py-2 rounded-full bg-[#082F49] text-white shadow-xl flex items-center justify-between font-bold hover:scale-105 transition-all group">
                                    <span className="text-sm md:text-base ml-2">Get A Demo</span>
                                    <div className="bg-[#0EA5E9] text-white w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center shrink-0"><span className="material-symbols-outlined text-xl md:text-2xl group-hover:rotate-45 transition-transform">arrow_forward</span></div>
                                </Link>
                            </div>
                        </div>

                        <div className="relative flex justify-center lg:justify-end h-full items-center scale-[0.85] md:scale-100">
                            <motion.div style={{ y: heroPhoneY }} className="relative z-10 w-[240px] md:w-[280px] border-[8px] md:border-[10px] border-white rounded-[2rem] md:rounded-[2.5rem] shadow-2xl bg-black overflow-hidden h-[500px] md:h-[580px]">
                                <PatientHome />
                            </motion.div>
                            <motion.div animate={{ y: [-10, 10, -10] }} transition={{ repeat: Infinity, duration: 4, ease: "easeInOut" }} className="absolute top-[25%] -left-8 md:-left-12 bg-white p-3 md:p-4 rounded-xl md:rounded-2xl shadow-xl z-20 flex items-center gap-2 md:gap-3">
                                <div className="p-2 md:p-3 bg-red-100 rounded-full text-red-600"><span className="material-symbols-outlined text-sm md:text-lg">favorite</span></div>
                                <div><p className="text-[10px] md:text-xs font-black text-gray-800">Heart Rate</p><p className="text-[8px] md:text-[10px] text-gray-500 font-bold">72 bpm • Normal</p></div>
                            </motion.div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-4 md:py-20">
                    <div className="max-w-7xl mx-auto px-6 text-center">
                        <p className="text-xs md:text-base font-black text-slate-400 uppercase tracking-widest mb-4 md:mb-10">Healthcare Reimagined</p>
                        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
                            {[
                                ...
                                { title: "Emergency Care", desc: "24/7 Rapid response coordination.", icon: "ambulance", color: "bg-red-100 text-red-600" }
                            ].map((item, i) => (
                                <motion.div key={i} initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.2, duration: 0.6 }} viewport={{ once: true }} className="flex flex-col items-center group cursor-pointer">
                                    ...
                                    <h3 className="text-sm md:text-xl font-black text-slate-900 mb-1 md:mb-2">{item.title}</h3>
                                    <p className="text-slate-500 max-w-xs text-[10px] md:text-base leading-tight">{item.desc}</p>
                                </motion.div>
                            ))}
                        </div>
                    </div>
                ...
                <section ref={userSectionRef} className="py-6 md:py-16 overflow-hidden relative">
                    <div className="absolute top-0 right-0 w-full lg:w-1/2 h-full bg-blue-50 lg:-skew-x-12 lg:translate-x-[20%] -z-10"></div>
                    <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-center">
                        <div className="visual relative flex justify-center scale-[0.85] md:scale-100">
                            <div className="relative z-10 w-[280px] md:w-[340px] border-[10px] md:border-[14px] border-white rounded-[2rem] md:rounded-[3rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] bg-white overflow-hidden h-[580px] md:h-[700px]">
                                <PatientHome />
                            </div>
                        </div>
                        <div className="content space-y-3 text-center lg:text-left">
                            <div>
                                <h4 className="text-[#0EA5E9] font-black tracking-[0.2em] uppercase text-[10px] md:text-sm mb-2 md:mb-4 inline-block bg-blue-50 px-4 py-2 rounded-full">For Patients</h4>
                                <h2 className="text-3xl md:text-6xl lg:text-7xl font-black text-[#082F49] leading-[1.1] tracking-tight">Care at Your <br /> Fingertips</h2>
                            </div>
                            <p className="text-sm md:text-base text-slate-500 leading-relaxed font-medium">Empower patients to take control of their health journey.</p>
                            <ul className="space-y-3">
                                {["Instant Doctor Booking", "Secure Lab Reports Access", "Medicine Reminders", "Family Health Management"].map((f, i) => (
                                    <li key={i} className="flex items-start gap-3 md:gap-4 p-2 md:p-3 rounded-2xl hover:bg-blue-50 transition-colors cursor-default border border-transparent hover:border-blue-100 text-left max-w-sm mx-auto lg:mx-0">
                                        <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-[#0EA5E9] flex items-center justify-center text-white mt-1 shrink-0 shadow-md"><span className="material-symbols-outlined text-[10px] md:text-sm font-bold">check</span></div>
                                        <span className="font-bold text-slate-800 text-sm md:text-lg">{f}</span>
                                    </li>
                                ))}
                            </ul>
                        </div>
                ...
                <section ref={driverSectionRef} className="py-6 md:py-16 overflow-hidden bg-[#082F49] text-white relative">
                    <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-center">
                        <div className="content space-y-3 order-2 lg:order-1 text-center lg:text-left">
                            <div>
                                <h4 className="text-[#0EA5E9] font-black tracking-[0.2em] uppercase text-[10px] md:text-sm mb-2 md:mb-4 inline-block bg-[#0EA5E9]/10 px-4 py-2 rounded-full">For Doctors</h4>
                                <h2 className="text-3xl md:text-6xl lg:text-7xl font-black text-white leading-[1.1] tracking-tight">Optimized <br /> Practice</h2>
                            </div>
                            <p className="text-sm md:text-base text-slate-300 leading-relaxed font-medium">Streamline clinical workflows and focus on what matters most—patient care.</p>
                            <div className="grid grid-cols-2 gap-3 md:gap-4 mt-6 text-left">
                                {[{ t: "Smart Schedule", i: "edit_calendar" }, { t: "Patient History", i: "history_edu" }, { t: "E-Prescriptions", i: "prescriptions" }, { t: "Secure Chat", i: "chat_bubble" }].map((x, i) => (
                                    <div key={i} className="bg-white/5 border border-white/10 p-3 md:p-4 rounded-xl md:rounded-3xl hover:bg-white/10 transition-colors flex items-center gap-2 md:gap-4">
                                        <span className="material-symbols-outlined text-[#0EA5E9] text-xl md:text-3xl">{x.i}</span><span className="font-bold text-xs md:text-lg">{x.t}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                        <div className="visual relative flex justify-center order-1 lg:order-2 scale-[0.85] md:scale-100">
                            <div className="relative z-10 w-[280px] md:w-[340px] border-[10px] md:border-[14px] border-slate-700/50 rounded-[2rem] md:rounded-[3rem] shadow-2xl bg-black overflow-hidden h-[500px] md:h-[700px] ring-1 ring-white/10">
                                <DoctorSchedule />
                            </div>
                        </div>
                    </div>
                ...
                <section ref={adminSectionRef} className="py-6 md:py-16 overflow-hidden relative bg-slate-50">
                    <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-center">
                        <div className="visual relative flex justify-center perspective-1000 scale-90 md:scale-100">
                            <div className="relative z-10 w-full max-w-xl aspect-[16/10] shadow-2xl rounded-xl md:rounded-2xl overflow-hidden border-[8px] md:border-[12px] border-white bg-white lg:rotate-y-12 shadow-blue-900/10"><HospitalAdmin /></div>
                        </div>
                        <div className="content space-y-3 text-center lg:text-left">
                            <div>
                                <h4 className="text-[#082F49] font-black tracking-[0.2em] uppercase text-[10px] md:text-sm mb-2 md:mb-4 inline-block bg-white px-4 py-2 rounded-full border border-gray-200 shadow-sm">Hospital Administration</h4>
                                <h2 className="text-3xl md:text-6xl lg:text-7xl font-black text-[#082F49] leading-[1.1] tracking-tight">Healthcare <br /> Operations</h2>
                            </div>
                            <p className="text-sm md:text-base text-slate-500 leading-relaxed font-medium">Efficiently manage resources, staff, and finances across your entire healthcare network.</p>
                            <div className="space-y-3 text-left max-w-md mx-auto lg:mx-0">
                                {[{ t: "Staff Management", d: "Rostering and performance." }, { t: "Resource Allocation", d: "Beds, OT, and inventory." }, { t: "Revenue Cycle", d: "Billing and insurance claims." }].map((x, i) => (
                                    <div key={i} className="flex gap-3 md:gap-4 group">
                                        <div className="w-10 h-10 md:w-14 md:h-14 bg-white rounded-xl md:rounded-2xl shadow-md flex items-center justify-center text-[#082F49] shrink-0 border border-gray-100 font-black text-lg md:text-2xl group-hover:bg-[#082F49] group-hover:text-[#0EA5E9] transition-colors duration-300">{i + 1}</div>
                                        <div><h4 className="font-bold text-slate-900 text-sm md:text-xl">{x.t}</h4><p className="text-slate-500 text-[10px] md:text-base mt-0.5 md:mt-2">{x.d}</p></div>
                                    </div>
                                ))}
                            </div>
                        </div>
                ...
                {/* --- CTA --- */}
                <section className="py-8 md:py-20 bg-[#082F49] relative overflow-hidden text-white">
                    <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
                        <h2 className="text-3xl md:text-6xl font-black mb-6 md:mb-8">Digitize Your Hospital</h2>
                        <Link to="/contact" className="px-8 md:px-10 py-4 md:py-5 bg-[#0EA5E9] text-white font-black rounded-full text-base md:text-lg shadow-xl hover:scale-105 transition-all inline-block">Begin Transformation</Link>
                    </div>
                </section>
