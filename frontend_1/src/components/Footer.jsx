...
const Footer = () => {
    return (
        <footer className="bg-[#012829] text-white pt-16 md:pt-20 pb-8 px-6 md:px-12 relative z-20 border-t border-white/5 font-sans overflow-hidden">
            {/* Decorative Elements */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                            {/* LinkedIn */}
                            <a href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/5 flex items-center justify-center hover:bg-[#0077B5] hover:border-[#0077B5] transition-all duration-300 group">
                            ...
                            {/* Instagram */}
                            <a href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/5 flex items-center justify-center hover:bg-[#E1306C] hover:border-[#E1306C] transition-all duration-300 group">
                            ...
                            {/* Twitter/X */}
                            <a href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/5 flex items-center justify-center hover:bg-black hover:border-gray-600 transition-all duration-300 group">
                            ...
                            {/* GitHub */}
                            <a href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/5 flex items-center justify-center hover:bg-[#333] hover:border-white/20 transition-all duration-300 group">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3 group">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:hello@appzeto.io" className="text-sm font-bold text-white group-hover:text-[#05A4A7] transition-colors">hello@appzeto.io</a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3 group">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+918882345678" className="text-sm font-bold text-white group-hover:text-[#05A4A7] transition-colors">+91 888 234 5678</a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-bold text-white group-hover:text-[#05A4A7] transition-colors leading-tight">Bangalore, India</p>
                                    </div>
                                </div>
                            </div>
                        </div>
