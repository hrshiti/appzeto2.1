    ...
    return (
        <section className="relative w-full min-h-screen bg-[#050505] overflow-hidden flex flex-col items-center justify-center py-20 font-sans">
                    ...
                    {projects.map((product, index) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <Link to={product.link} className="flex flex-col items-center gap-3">
                                    {/* Icon Circle */}
                                    <div className={`
                                        ...
                                        ${hoveredProduct?.id === product.id ? 'scale-110 border-teal-500 ring-4 ring-teal-500/20' : 'hover:scale-105 group-hover:border-white/30'}
                                    `}>
                                        ...
                                        <span
                                            ...
                                            style={{ color: hoveredProduct?.id === product.id ? '#05A4A7' : product.color }}
                                        >
                                            {product.icon}
                                        </span>
                                    </div>
                                    ...
                                    <div className={`
                                        ...
                                        ${hoveredProduct?.id === product.id ? 'opacity-100 translate-y-0 border-teal-500/50' : 'opacity-70 group-hover:opacity-100'}
                                    `}>
                                        <p className="text-[10px] sm:text-xs font-bold text-gray-200 whitespace-nowrap">{product.title}</p>
                                    </div>
                                </Link>
                                    ...
                                    {hoveredProduct?.id === product.id && (
                                        ...
                                        >
                                            <div className="flex items-center gap-2 mb-3">
                                                ...
                                                <span className="text-xs font-bold text-gray-500 uppercase tracking-widest">{product.subtitle}</span>
                                            </div>
                                            ...
                                            <h4 className="font-black text-white text-lg leading-tight">{product.title}</h4>
                                            <p className="text-xs text-gray-400 font-medium leading-relaxed mt-2 line-clamp-2">{product.description}</p>

                                            <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between">
                                                <span className="text-[10px] font-bold text-gray-500">Tap to explore product</span>
            ...
            <div className="absolute bottom-10 md:hidden text-center w-full px-10">
                <p className="text-xs text-gray-600 font-bold uppercase tracking-widest animate-pulse">Explore the Product Suite</p>
            </div>
