...
const Projects = () => {
    return (
        <div className="bg-background-light dark:bg-background-dark text-[#111817] dark:text-white font-display overflow-x-hidden antialiased transition-colors duration-300">
            {/* Navbar */}
            ...
            <main className="flex flex-col items-center w-full min-h-screen pb-20">
                ...
                <div className="w-full max-w-7xl px-4 md:px-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        <div className="md:col-span-2 group @container">
                            <div className="flex flex-col @3xl:flex-row items-stretch rounded-2xl bg-[#0b121e] dark:bg-[#0b121e] shadow-lg border border-gray-800 overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-primary/30">
                                ...
                                <div className="flex flex-col justify-center p-6 @3xl:p-10 w-full @3xl:w-2/5 gap-4">
                                    ...
                                    <h3 className="text-2xl @3xl:text-3xl font-bold text-white group-hover:text-primary transition-colors">Appzeto Taxi</h3>
                        ...
                        <div className="group flex flex-col rounded-2xl bg-[#0b121e] dark:bg-[#0b121e] shadow-lg border border-gray-800 overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                            ...
                            <div className="p-6 flex flex-col flex-1 gap-3">
                                <h3 class="text-xl font-bold text-white group-hover:text-primary transition-colors">Appzeto Food</h3>
                        ...
                        <div className="group flex flex-col rounded-2xl bg-[#0b121e] dark:bg-[#0b121e] shadow-lg border border-gray-800 overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                            ...
                            <div className="p-6 flex flex-col flex-1 gap-3">
                                <h3 className="text-xl font-bold text-white group-hover:text-primary transition-colors">Appzeto Shop</h3>
                                <p className="text-gray-300 text-sm leading-relaxed flex-1">
                        ...
                        <div className="group flex flex-col rounded-2xl bg-[#0b121e] dark:bg-[#0b121e] shadow-lg border border-gray-800 overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                            ...
                            <div className="p-6 flex flex-col flex-1 gap-3">
                                <h3 className="text-xl font-bold text-white group-hover:text-primary transition-colors">Appzeto Health</h3>
                                <p className="text-gray-300 text-sm leading-relaxed flex-1">
                        ...
                        <div className="group flex flex-col rounded-2xl bg-[#0b121e] dark:bg-[#0b121e] shadow-lg border border-gray-800 overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                            ...
                            <div className="p-6 flex flex-col flex-1 gap-3">
                                <h3 className="text-xl font-bold text-white group-hover:text-primary transition-colors">Appzeto CRM</h3>
                                <p className="text-gray-300 text-sm leading-relaxed flex-1">
                ...
                {/* CTA Section */}
                <div className="w-full max-w-7xl px-4 md:px-10 mt-24">
                    <div className="relative overflow-hidden rounded-3xl bg-background-dark px-8 py-16 md:px-16 md:py-20 text-center shadow-2xl">
                        {/* Background Pattern */}
                        <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none" style={{ backgroundImage: 'radial-gradient(#13ecc8 1px, transparent 1px)', backgroundSize: '24px 24px' }}>
                        </div>
                        ...
                        <div className="relative z-10 flex flex-col items-center max-w-2xl mx-auto">
                            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 tracking-tight">Have a Vision for Your Next Project?</h2>
                            <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                                Our team of experts is ready to help you build scalable, modern, and high-performance digital solutions tailored to your needs.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                                <button className="bg-primary hover:bg-primary/90 text-background-dark font-bold text-base py-3.5 px-8 rounded-xl shadow-[0_0_20px_rgba(19,236,200,0.4)] transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(19,236,200,0.6)]">
                                    Start Your Project
                                </button>
                                <button className="bg-transparent border-2 border-gray-600 hover:border-white text-white font-bold text-base py-3.5 px-8 rounded-xl transition-all hover:bg-white/5">
                                    Schedule a Call
                                </button>
                            </div>
                        </div>
            ...
            {/* Footer */}
            <footer className="w-full bg-white dark:bg-card-dark border-t border-gray-100 dark:border-gray-800 py-8 mt-12">
                <div className="max-w-7xl mx-auto px-6 text-center text-gray-400 dark:text-gray-500 text-sm">
                    <p>© 2023 Appzeto Inc. All rights reserved.</p>
                </div>
            </footer>
        </div>
    );
