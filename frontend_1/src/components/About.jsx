    ...
    return (
        <div className="relative z-30 w-full bg-[#f6f8f8] dark:bg-[#012829] text-[#111817] transition-colors duration-200">
            <div className="flex-1">
                {/* Vision Section */}
                <section className="relative w-full py-20 lg:py-32 px-4 md:px-10 overflow-hidden bg-[#ffffff] dark:bg-[#023638]">
                        ...
                        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                            <div className="relative z-10 flex flex-col gap-8">
                                <div className="flex flex-col gap-4">
                                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#05A4A7]/10 border border-[#05A4A7]/20 w-fit">
                                        <span className="flex h-2 w-2 rounded-full bg-[#05A4A7] animate-pulse"></span>
                                        <span className="text-xs font-bold uppercase tracking-wider text-[#0d9488] dark:text-[#05A4A7]">Who We Are</span>
                                    </div>
                            ...
                            <div className="relative z-10 lg:pl-10">
                                ...
                                <div className="absolute -bottom-8 -left-8 w-64 h-64 bg-[#ffffff] dark:bg-[#023638] rounded-full mix-blend-multiply filter blur-3xl opacity-50 dark:opacity-20"></div>
                                ...
                                <div className="absolute -top-6 -left-6 bg-[#ffffff] dark:bg-[#023638] p-4 pr-6 rounded-lg shadow-[0_8px_30px_rgb(0,0,0,0.12)] border-l-4 border-[#05A4A7] flex items-center gap-4 hover:-translate-y-1 transition-transform duration-300">
                ...
                {/* Values Section */}
                <section className="w-full bg-[#f6f8f8] dark:bg-[#012829] py-20 px-4 md:px-20 lg:px-40">
                    <div className="max-w-[1080px] mx-auto flex flex-col gap-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="bg-[#ffffff] dark:bg-[#023638] p-8 rounded-xl shadow-sm border border-transparent hover:border-[#05A4A7]/50 transition-all duration-300 hover:-translate-y-1">
                                <div className="size-12 rounded-lg bg-[#05A4A7]/10 flex items-center justify-center mb-6 text-[#05A4A7]">
                ...
                {/* Trusted By Section */}
                <section className="w-full bg-[#ffffff] dark:bg-[#023638] py-12 border-t border-[#f0f4f4] dark:border-gray-800">
                ...
                {/* CTA Section */}
                <section className="w-full bg-[#f6f8f8] dark:bg-[#012829] py-24 px-4">
                    <div className="max-w-4xl mx-auto text-center bg-[#ffffff] dark:bg-[#023638] rounded-2xl p-10 md:p-16 shadow-lg border border-[#05A4A7]/20 relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-[#05A4A7]/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                            ...
                            <button className="flex min-w-[160px] cursor-pointer items-center justify-center rounded-lg h-12 px-6 bg-transparent border-2 border-gray-200 dark:border-gray-700 hover:border-[#05A4A7] hover:text-[#05A4A7] transition-colors text-[#111817] dark:text-white text-base font-bold">
                                View Case Studies
                            </button>
                        </div>
                    </div>
            ...
            {/* Footer */}
            <footer className="bg-[#ffffff] dark:bg-[#023638] border-t border-[#f0f4f4] dark:border-gray-800 pt-16 pb-8 px-4 md:px-20 lg:px-40">
                <div className="max-w-[1080px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                    <div className="col-span-1 md:col-span-1">
                        <div className="flex items-center gap-2 text-[#111817] dark:text-white mb-4">
                            <div className="size-6 flex items-center justify-center text-[#05A4A7]">
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-2 text-sm text-[#618983] dark:text-gray-400">
                            <li><a className="hover:text-[#05A4A7] transition-colors" href="#">About Us</a></li>
                            <li><a className="hover:text-[#05A4A7] transition-colors" href="#">Careers</a></li>
                            <li><a className="hover:text-[#05A4A7] transition-colors" href="#">Blog</a></li>
                            <li><a className="hover:text-[#05A4A7] transition-colors" href="#">Contact</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="font-bold mb-4 text-[#111817] dark:text-white">Services</h4>
                        <ul className="flex flex-col gap-2 text-sm text-[#618983] dark:text-gray-400">
                            <li><a className="hover:text-[#05A4A7] transition-colors" href="#">Web Development</a></li>
                            <li><a className="hover:text-[#05A4A7] transition-colors" href="#">Mobile Apps</a></li>
                            <li><a className="hover:text-[#05A4A7] transition-colors" href="#">AI & ML Solutions</a></li>
                            <li><a className="hover:text-[#05A4A7] transition-colors" href="#">Cloud Architecture</a></li>
                        </ul>
                    </div>
                    <div>
                ...
                <div className="max-w-[1080px] mx-auto pt-8 border-t border-gray-100 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-4">
                        <a className="text-[#618983] dark:text-gray-500 hover:text-[#05A4A7]" href="#"><span className="sr-only">LinkedIn</span><svg className="size-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path></svg></a>
                        <a className="text-[#618983] dark:text-gray-500 hover:text-[#05A4A7]" href="#"><span className="sr-only">Twitter</span><svg className="size-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg></a>
                    </div>
                </div>
            </footer>
        </div>
