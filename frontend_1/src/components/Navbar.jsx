...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="fixed top-0 z-50 w-full bg-white/95 dark:bg-[#023638]/95 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 transition-colors duration-300">
