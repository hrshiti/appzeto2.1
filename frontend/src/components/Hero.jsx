...
const Hero = () => {
    ...
    return (
        <div className="w-full h-[calc(100vh-80px)] max-w-[1700px] mx-auto px-6 md:px-10 flex flex-col pb-0">
            ...
            <div className="flex-none flex items-end justify-between pt-2 pb-4 border-b border-gray-300">
                <h1 className="text-[9vw] leading-[0.8] font-bold tracking-tighter text-gray-900">
                    APPZETO
                </h1>
                <p className="hidden md:block text-gray-700 text-xs leading-tight max-w-xs text-right pb-2">
            ...
            <div className="flex-none grid grid-cols-3 gap-2 py-3 items-center">
                ...
                <div className="text-right text-[10px] font-semibold text-gray-500 uppercase tracking-wide">
                    INDIA, GLOBAL
                </div>
            </div>
            ...
            <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-3 gap-6 pb-2">
                ...
                {/* Left Sidebar Service List - Simplified */}
                <div className="hidden lg:flex flex-col justify-end pb-16 pl-2">
